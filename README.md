...
[![](https://img.shields.io/badge/devel%20version-0.7.2-blue.svg)](https://github.com/william-swl/baizer)
...
v
#>  [1] "A99"  "B101" "A10"  "B9"   "B1"   "A9"   "B32"  "B21"  "A1"   "A2"  
#> [11] "A12"  "B102" "A101" "B10"  "A102" "B2"   "B99"  "A11"

group_vector(v)
#> $A
#> [1] "A99"  "A10"  "A9"   "A1"   "A2"   "A12"  "A101" "A102" "A11" 
#> 
#> $B
#> [1] "B101" "B9"   "B1"   "B32"  "B21"  "B102" "B10"  "B2"   "B99"

group_vector(v, pattern = "\\w\\d")
#> $A1
#> [1] "A10"  "A1"   "A12"  "A101" "A102" "A11" 
#> 
#> $A2
#> [1] "A2"
#> 
...
group_vector(v, pattern = "\\w(\\d)")
#> $`1`
#>  [1] "B101" "A10"  "B1"   "A1"   "A12"  "B102" "A101" "B10"  "A102" "A11" 
#> 
#> $`2`
#> [1] "B21" "A2"  "B2" 
#> 
...
v
#> [1] "id11"  "id12"  "id2"   "id101" "id99"  "id1"   "id102" "id9"   "id10"
...
v
#>  [1] "B102" "B10"  "A10"  "A11"  "B99"  "A99"  "A102" "A1"   "A12"  "A9"  
#> [11] "B32"  "B101" "A2"   "B2"   "A101" "B9"   "B1"   "B21"
...
#>       V1     V2     V3     V4
#>    <dbl>  <dbl>  <dbl>  <dbl>
#> 1  1.48   0.206  1.08  -1.79 
#> 2 -0.640 -0.581 -1.36  -0.634
#> 3 -0.259 -0.717 -0.263  1.63
...
#> [3] "--no-restore"                          
#> [4] "-f"                                    
#> [5] "/tmp/RtmpjsGrCV/callr-scr-4a2b38a10365"
